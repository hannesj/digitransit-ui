...
const translations = {
  ...
  hr: {
    ...
    'approx-meters': '{approxDistance} m',
    'aria-itinerary-summary': 'Ukupno vrijeme putovanja {duration} ',
    'aria-itinerary-summary-bike-distance':
      'Ukupna biciklistička udaljenost {distance} ',
    'aria-itinerary-summary-walk-distance':
      'Ukupna udaljenost pješačenja {distance} ',
    'arrive-leave': 'Dolazak ili odlazak u odabrano vrijeme',
    'arriving-at': 'Dolasci',
    ...
    'bikes-available': 'Broj bicikala na stanici {amount}',
    ...
    'choose-stop-or-vehicle': 'Odaberite vozilo ili se zaustavite',
    'choose-vehicle': 'Odaberite vozilo',
    citybike: 'Gradski bicikl',
    'citybike-buy-season': 'Kupite dnevnu, tjednu ili sezonsku kartu',
    'citybike-distance-duration': 'Bike {distance} ({duration})',
    'citybike-network-headers': 'Citybikes and scooters',
    'citybike-off-season':
      'Stanice za bicikle će biti ponovno dostupne slijedeće proljeće',
    'citybike-purchase-link': 'Kupite',
    'citybike-register-required':
      'Morare kreirati korisnički račun kako bi koristili gradske bicikle',
    'citybike-start-using': 'Počnite koristiti gradske bicikle',
    'citybike-station': 'Biciklistička stanica {stationId}',
    'citybike-station-no-id': 'Biciklistička stanica',
    citybike_off: 'Zatvoreno',
    'clear-button-label': 'Obriši',
    close: 'Zatvori',
    'close-favourite-module': 'Zatvorite modul Favoriti ',
    'close-settings': 'Zatvorite prozor i spremite postavke',
    ...
    'departure-time-in-minutes': '{minutes} min',
    departures: 'Odlasci',
    'departures-by-hour': 'Polasci po satima (minute / linija)',
    description: 'Pronađi transportne usluge.',
    destination: 'Odredište',
    'destination-label-change': 'Promijenite odredište',
    'destination-outside-service':
    ...
    instructions: 'Koraci',
    'itinerary-details.biking-leg':
      'Polaskom u {time}, udaljenost biciklom je {distance} od {origin} do {destination}. Procijenjeno trajanje {duration}',
    'itinerary-details.car-leg':
      'Polaskom u {time}, udaljenost autom je {distance} od {origin} do {destination}. Procijenjeno trajanje {duration}',
    'itinerary-details.end-leg': 'U {time} stići ćete do {destination}.',
    'itinerary-details.route-has-info-alert': 'Ruta ima upozorenja.',
    'itinerary-details.route-has-severe-alert': 'Ruta ima smetnje.',
    'itinerary-details.route-has-unknown-alert': 'Ruta ima smetnje.',
    'itinerary-details.route-has-warning-alert': 'Ruta ima smetnje.',
    'itinerary-details.scooter-leg':
      'Polaskom u {time}, udaljenost kick skuterom je {distance} od {origin} do {destination}. Procijenjeno trajanje {duration}',
    'itinerary-details.transit-leg-part-1': 'Preuzmi u {time}',
    'itinerary-details.transit-leg-part-2':
      'TODO(from stop {startStop} {trackInfo} to stop {endStop}. Estimated duration {duration})',
    'itinerary-details.walk-leg':
      'TODO(At {time} walk {distance} from {origin} to {destination}. Estimated time {duration})',
    ...
    'itinerary-page.itineraries-loaded': 'TODO(More itineraries loaded)',
    'itinerary-page.loading-itineraries': 'TODO(Loading more itineraries)',
    'itinerary-page.show-details': 'Prikaži podatke o turi',
    'itinerary-page.show-details-label':
      'TODO(Show itinerary {number} details)',
    'itinerary-page.title': 'Tura',
    'itinerary-page.update-alert': 'TODO(Search results updated)',
    'itinerary-summary-page-street-mode.update-alert':
      'TODO(Walking and biking results updated)',
    'itinerary-summary-page.description': 'Prijedlozi ruta',
    'itinerary-summary-page.title': 'Prijedlozi ruta',
    'itinerary-summary-row.biking-distance':
      'TODO(Total biking distance {totalDistance}.)',
    'itinerary-summary-row.clickable-area-description': 'TODO(Show on map)',
    'itinerary-summary-row.description':
      'TODO(Itinerary departing at {departureDate} {departureTime} and arriving at {arrivalDate} {arrivalTime}. {firstDeparture} {transfers} Total time {totalTime}.)',
    'itinerary-summary-row.first-departure':
      'TODO({vehicle} leaves at {departureTime} from stop {stopName}.)',
    'itinerary-summary-row.first-leg-start-time':
      'TODO(Leaves at {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform})',
    'itinerary-summary-row.first-leg-start-time-citybike':
      'TODO(Departure at {firstDepartureTime} from {firstDepartureStop} bike station)',
    'itinerary-summary-row.no-transit-legs': 'TODO(Leave when it suits you)',
    'itinerary-summary-row.transfers':
      'TODO(Transfer to {vehicle} on stop {stopName})',
    'itinerary-summary-row.walking-distance':
      'TODO(Total walking distance {totalDistance}.)',
    'itinerary-summary.bikeAndPublic-fallback-title':
      'TODO(Take your bike with you onboard)',
    'itinerary-summary.bikeAndPublic-rail-subway-title':
      'TODO(Take your bike with you on the train or to metro)',
    'itinerary-summary.bikeAndPublic-rail-title':
      'TODO(Take your bike with you on the train)',
    'itinerary-summary.bikeAndPublic-subway-title':
      'TODO(Take your bike to metro)',
    'itinerary-summary.bikePark-title':
      'TODO(Leave your bike at a Park & Ride)',
    'itinerary-summary.interline-wait':
      'TODO(Wait for the transfer onboard ({time}))',
    'itinerary-summary.show-on-map': 'TODO(Show on map {target})',
    ...
    login: 'Prijava',
    'login-content':
      'TODO(To save and utilize places, routes and stops, you must log in using your HSL account.)',
    'login-header': 'TODO(Log in First)',
    logout: 'TODO(Log out)',
    'long-transfers-margin': '12 min',
    ...
    'more-departures': 'TODO(More departures)',
    'more-settings': 'Ostale postavke',
    navigate: 'Navigacija',
    nearest: 'Najbliži',
    'nearest-stops': 'TODO(The closest stops)',
    'nearest-stops-bus': 'TODO(The closest bus stops)',
    'nearest-stops-citybike': 'TODO(The closest bike stations)',
    'nearest-stops-ferry': 'TODO(The closest ferry piers)',
    'nearest-stops-rail': 'TODO(The closest train stations)',
    'nearest-stops-subway': 'TODO(The closest metro stations)',
    'nearest-stops-tram': 'TODO(The closest tram stops)',
    'nearest-stops-update-location': 'TODO(Update {mode})',
    'nearest-stops-updated-location': 'TODO(Location on the map has changed)',
    neighbourhood: 'TODO(Neighbourhood )',
    ...
    'no-route-msg-with-changes':
      'TODO(Unfortunately, no route suggestions were found. Please check your search settings or try changing the origin or destination.)',
    'no-route-origin-near-destination':
      'Polazna i odredišna točka su preblizu. Molimo odaberittet druge lokacije.',
    'no-route-origin-same-as-destination':
      'TODO(No route suggestions were found because the origin and destination are the same.)',
    'no-route-showing-alternative-options':
      'TODO(No route suggestions were found with the your settings. However, we found the following route options:)',
    'no-route-start-date-too-early':
    ...
    or: 'ili',
    origin: 'Polazište',
    'origin-label-change': 'TODO(Change origin)',
    'origin-outside-service':
    ...
    'pick-mode-airplane-disabled': 'TODO(Flight not selected)',
    'pick-mode-airplane-enabled': 'TODO(Flight selected)',
    'pick-mode-bus-disabled': 'TODO(Bus not selected)',
    'pick-mode-bus-enabled': 'TODO(Bus selected)',
    'pick-mode-citybike-disabled': 'TODO(Citybike not selected)',
    'pick-mode-citybike-enabled': 'TODO(Citybike selected)',
    'pick-mode-ferry-disabled': 'TODO(Ferry not selected)',
    'pick-mode-ferry-enabled': 'TODO(Ferry selected)',
    'pick-mode-rail-disabled': 'TODO(Rail not selected)',
    'pick-mode-rail-enabled': 'TODO(Rail selected)',
    'pick-mode-selected': 'TODO(Selected transport modes)',
    'pick-mode-subway-disabled': 'TODO(Metro not selected)',
    'pick-mode-subway-enabled': 'TODO(Metro selected)',
    'pick-mode-tram-disabled': 'TODO(Tram not selected)',
    'pick-mode-tram-enabled': 'TODO(Tram selected)',
    'pick-street-mode': 'TODO(My modes of transport)',
    ...
    'remove-favourite': 'TODO(Remove favourite selection)',
    ...
    'search-autosuggest-label':
      'TODO(Venue, place and stopsearch. Navigate list with arrow keys and select with enter key)',
    'search-autosuggest-len':
      'TODO(There {len, plural, =1 {is 1 suggestion} other {are {len} suggestions}} available)',
    'search-button-label': 'Pretraživanje',
    'search-current-suggestion': 'TODO(Current selection: {selection})',
    'search-destination': 'Pretraži odredište, rutu ili stajalište',
    'search-destination-index': 'TODO(Enter destination)',
    'search-destination-results-but-no-search':
      'Prikaži rezultate u tabu "Odredišta"',
    'search-no-results': 'Nema lokacije',
    'search-origin': 'Pretraži polazište, rutu ili stajalište',
    'search-origin-index': 'TODO(Enter origin)',
    'search-position': 'Dohvati lokaciju',
    'search-search-results-but-no-destination':
      'Prikaži rezulttate u tabu "O ruti ili stajalištu"',
    'searching-position': 'Dohvaćanje lokacije...',
    'select-all-routes': 'TODO(Select all routes)',
    'select-date': 'TODO(Select date)',
    'select-from-map-destination': 'TODO(Select destination)',
    'select-from-map-no-title': 'TODO(No title)',
    'select-from-map-origin': 'TODO(Select origin)',
    'select-from-map-viaPoint': 'TODO(Select viapoint)',
    'select-map-layers-header': 'Što želite prikazati na karti?',
    'select-position': 'Odaberi lokaciju iz prijašnjih pretraživanja',
    'select-route': 'TODO(Select {mode} route {shortName} to {headsign})',
    send: 'Pošalji',
    ...
    'set-specific-settings': 'TODO(Set more specific settings)',
    'set-time-earlier-button-label': 'TODO(Set travel time to earlier)',
    'set-time-later-button-label': 'TODO(Set travel time to later)',
    'set-time-now-button-label': 'TODO(Set travel time to current)',
    settings: 'Postavke',
    'settings-dropdown-close-label': 'TODO(Close options)',
    'settings-dropdown-open-label': 'TODO(Open options)',
    'settings-label-change': 'Promijeni postavke',
    share: 'Podijeli rutu',
    show: 'Prikaži',
    'show-departures': 'Prikaži polazišta',
    'show-more': 'Prikaži više',
    'show-more-stops-near-you': 'TODO(Show more stops near you)',
    ...
    stop: 'Stajalište',
    'stop-near-you': 'TODO(Search stops and routes near you)',
    'stop-near-you-modal-grant-permission': 'TODO(or enable location services)',
    'stop-near-you-modal-grant-permission-info':
      'TODO(You can enable location services in your phone or browser settings, allowing the service to use your current location.)',
    'stop-near-you-modal-header':
      'TODO(You have not enabled location services)',
    'stop-near-you-modal-info':
      'TODO(Using the nearby stops function requires location access.)',
    'stop-near-you-title': 'Pretražite stajališta i rute',
    'stop-near-you-update-alert': 'TODO(Nearest stops updated)',
    'stop-number': 'Broj stajališta',
    'stop-page.description': 'Stajalište {name} - {code}',
    'stop-page.right-now.loaded': 'TODO(stop page loaded)',
    ...
    'street-mode-bike-aria':
      'TODO(Show cycle route. Duration {duration}, distance {length})',
    'street-mode-bikeandvehicle-aria':
      'TODO(Show a combination of cycling and public transport. Duration {duration}, distance {length})',
    ...
    'street-mode-walk-aria':
      'TODO(Show walking route. Duration {duration}, distance {length})',
    subway: 'Metro',
    'subway-with-route-number': 'Metro {routeNumber} {headSign}',
    'summary-page.description': '{from} - {to}',
    ...
    tickets: 'Karte',
    time: 'Vrijeme',
    'time-navigation-buttons': 'TODO(Time navigation buttons)',
    'time-selector-form': 'TODO(Edit time)',
    ...
    'use-national-service-postfix': 'TODO(.)',
    'use-national-service-prefix':
      'TODO(We recommend you try the national journey planner, )',
    'use-own-position': 'Koristi trenutnu lokaciju',
    userinfo: 'TODO(My information)',
    ...
    'via-point': 'Točka',
    'via-point-index': 'TODO(Via point {index})',
    'viapoint-slack-amount': 'Vrijeme zaustavljanja',
    'view-route': 'Pregledaj Routu',
    wait: 'Čekanje',
    'wait-amount-of-time': 'Čekanje {duration}',
    walk: 'hodanje',
    'walk-bike-itinerary-1': 'TODO(Your search returned only walking routes.)',
    'walk-bike-itinerary-2': 'TODO(Your search returned only cycling routes.)',
    'walk-bike-itinerary-3':
      'TODO(Your search returned only walking and cycling routes.)',
    ...
    'weather-data-source': 'TODO(Source: Finnish Meteorological Institute)',
    'weather-detail-title': 'TODO(Weather forecast for the place of origin at)',
    'weather-icon-1': 'TODO(Clear)',
    'weather-icon-2': 'TODO(Partly cloudy)',
    'weather-icon-21': 'TODO(Light showers)',
    'weather-icon-22': 'TODO(Showers)',
    'weather-icon-23': 'TODO(Heavy showers)',
    'weather-icon-3': 'TODO(Overcast)',
    'weather-icon-31': 'TODO(Light rain)',
    'weather-icon-32': 'TODO(Rain)',
    'weather-icon-33': 'TODO(Heavy rain)',
    'weather-icon-41': 'TODO(Light snow showers)',
    'weather-icon-42': 'TODO(Snow showers)',
    'weather-icon-43': 'TODO(Heavy snow showers)',
    'weather-icon-51': 'TODO(Light snowfall)',
    'weather-icon-52': 'TODO(Snowfall)',
    'weather-icon-53': 'TODO(Heavy snowfall)',
    'weather-icon-61': 'TODO(Thundershowers)',
    'weather-icon-62': 'TODO(Heavy thundershowers)',
    'weather-icon-63': 'TODO(Thunder)',
    'weather-icon-64': 'TODO(Heavy thunder)',
    'weather-icon-71': 'TODO(Light sleet showers)',
    'weather-icon-72': 'TODO(Sleet showers)',
    'weather-icon-73': 'TODO(Heavy sleet showers)',
    'weather-icon-81': 'TODO(Light sleet)',
    'weather-icon-82': 'TODO(Sleet)',
    'weather-icon-83': 'TODO(Heavy sleet)',
    'weather-icon-91': 'TODO(Mist)',
    'weather-icon-92': 'TODO(Fog)',
    where: 'Gdje ideš?',
    yesterday: 'Jučer',
    zone: 'Zona',
    zones: 'Zone',
