...
const translations = {
  ...
  hr: {
    ...
    'itinerary-details.transit-leg-part-2':
      'od stajališta {startStop} {trackInfo} do stajališta {endStop}. Procijenjeno trajanje {duration}',
    'itinerary-details.walk-leg':
      'Polaskom u {time} šetajući {distance} od {origin} do {destination}. Procijenjeno trajanje {duration})',
    ...
    'itinerary-page.itineraries-loaded': 'Učitano je više planova puta',
    'itinerary-page.loading-itineraries': 'Učitavanje više planova puta',
    'itinerary-page.show-details': 'Prikaži podatke o turi',
    'itinerary-page.show-details-label': 'Prikaz {number} detalja plana puta',
    'itinerary-page.title': 'Tura',
    'itinerary-page.update-alert': 'Rezultati pretraživanja ažurirani',
    'itinerary-summary-page-street-mode.update-alert':
      'Ažurirani rezultati pješačenja i biciklizma',
    'itinerary-summary-page.description': 'Prijedlozi ruta',
    'itinerary-summary-page.title': 'Prijedlozi ruta',
    'itinerary-summary-row.biking-distance':
      'Ukupna biciklistička udaljenost {totalDistance}.',
    'itinerary-summary-row.clickable-area-description': 'Prikaži na mapi',
    'itinerary-summary-row.description':
      'Plan puta s polaskom {departureDate} u {departureTime} i dolaskom {arrivalDate} u {arrivalTime}. {firstDeparture} {transfers} Ukupno vrijeme {totalTime}.)',
    'itinerary-summary-row.first-departure':
      '{vehicle} u {departureTime} napušta stajalište {stopName}.)',
    'itinerary-summary-row.first-leg-start-time':
      'Napušta u {firstDepartureTime} {firstDepartureStopType} {firstDepartureStop}{firstDeparturePlatform}',
    'itinerary-summary-row.first-leg-start-time-citybike':
      'Polazak u {firstDepartureTime} s {firstDepartureStop} biciklističke stanice',
    'itinerary-summary-row.no-transit-legs': 'Otiđite kada vam odgovara',
    'itinerary-summary-row.transfers':
      'Transfer do {vehicle} na stajalištu {stopName}',
    'itinerary-summary-row.walking-distance':
      'Ukupna udaljenost pješačenja {totalDistance}.',
    'itinerary-summary.bikeAndPublic-fallback-title':
      'Ponesite bicikl sa sobom',
    'itinerary-summary.bikeAndPublic-rail-subway-title':
      'Ponesite bicikl sa sobom u vlak ili u metro',
    'itinerary-summary.bikeAndPublic-rail-title':
      'Ponesite bicikl sa sobom u vlak',
    'itinerary-summary.bikeAndPublic-subway-title':
      'Ponesite bicikl sa sobom u metro',
    'itinerary-summary.bikePark-title': 'Ostavite svoj biciklk u Park & Ride',
    'itinerary-summary.interline-wait': 'Pričekajte na ukrcavanje ({time})',
    'itinerary-summary.show-on-map': 'Prikaži na mapi {target}',
    ...
    login: 'Prijava',
    'login-content':
      'Da biste spremili i iskoristili mjesta, rute i stajališta, morate se prijaviti koristeći svoj HSL račun.',
    'login-header': 'Prvo se prijavite',
    logout: 'Odjavi se',
    'long-transfers-margin': '12 min',
    ...
    'more-departures': 'Još polazaka',
    'more-settings': 'Ostale postavke',
    navigate: 'Navigacija',
    nearest: 'Najbliži',
    'nearest-stops': 'Najbliža stajališta',
    'nearest-stops-bus': 'Najbliža autobusna stajališta',
    'nearest-stops-citybike': 'Najbliže biciklističke stanice',
    'nearest-stops-ferry': 'Najbliža trajektna pristaništa',
    'nearest-stops-rail': 'Najbliže željezničke stanice',
    'nearest-stops-subway': 'Najbliže stanice metroa',
    'nearest-stops-tram': 'Najbliža tramvajska stajališta',
    'nearest-stops-update-location': 'Ažuriraj {mode}',
    'nearest-stops-updated-location': 'Položaj na karti se promijenio',
    ...
    'no-route-msg-with-changes':
      'Nažalost, nisu pronađeni prijedlozi ruta. Provjerite postavke pretraživanja ili pokušajte promijeniti polazište ili odredište.',
    'no-route-origin-near-destination':
      'Polazna i odredišna točka su preblizu. Molimo odaberittet druge lokacije.',
    'no-route-origin-same-as-destination':
      'Nisu pronađeni prijedlozi ruta jer su polazište i odredište isti.',
    'no-route-showing-alternative-options':
      'Nije pronađen nijedan prijedlog rute s vašim postavkama. Međutim, pronašli smo sljedeće opcije rute:',
    'no-route-start-date-too-early':
    ...
    or: 'ili',
    origin: 'Polazište',
    'origin-label-change': 'Promijeni polazište',
    'origin-outside-service':
    ...
    'pick-mode-airplane-disabled': 'Let nije odabran',
    'pick-mode-airplane-enabled': 'Let odabran',
    'pick-mode-bus-disabled': 'Autobus nije odabran',
    'pick-mode-bus-enabled': 'Autobus odabran',
    'pick-mode-citybike-disabled': 'Gradski bicikl nije odabran',
    'pick-mode-citybike-enabled': 'Gradski bicikl odabran',
    'pick-mode-ferry-disabled': 'Trajekt nije odabran',
    'pick-mode-ferry-enabled': 'Trajekt odabran',
    'pick-mode-rail-disabled': 'Željeznica nije odabrana',
    'pick-mode-rail-enabled': 'Željeznica odabrana',
    'pick-mode-selected': 'Odabrani načini prijevoza',
    'pick-mode-subway-disabled': 'Metro nije odabran',
    'pick-mode-subway-enabled': 'Metro odabran',
    'pick-mode-tram-disabled': 'Tramvaj nije odabran',
    'pick-mode-tram-enabled': 'Tramvaj odabran',
    'pick-street-mode': 'Moji načini prijevoza',
    ...
    'remove-favourite': 'Ukloni odabir favorita',
    ...
    'search-current-suggestion': 'Trenutni odabir: {selection}',
    ...
    'select-all-routes': 'Odaberite sve rute',
    'select-date': 'Odaberite datum',
    'select-from-map-destination': 'Odaberite odredište',
    'select-from-map-no-title': 'Bez naslova',
    'select-from-map-origin': 'Odaberite polazište',
    'select-from-map-viaPoint': 'Odaberite kao točku',
    ...
    'set-specific-settings': 'Postavite preciznije postavke',
    'set-time-earlier-button-label': 'Postavite vrijeme putovanja na ranije',
    'set-time-later-button-label': 'Postavite vrijeme putovanja na kasnije',
    'set-time-now-button-label': 'Postavite vrijeme putovanja na trenutno',
    settings: 'Postavke',
    'settings-dropdown-close-label': 'Zatvori opcije',
    'settings-dropdown-open-label': 'Otvori opcije',
    'settings-label-change': 'Promijeni postavke',
    share: 'Podijeli rutu',
    show: 'Prikaži',
    'show-departures': 'Prikaži polazišta',
    'show-more': 'Prikaži više',
    'show-more-stops-near-you': 'Prikaži više obližnjih stajališta',
    ...
    station: 'Stanice',
    stop: 'Stajalište',
    'stop-near-you': 'Pretražite stanice i rute u svojoj blizini',
    'stop-near-you-modal-grant-permission': 'ili omogućite lokacijske usluge',
    'stop-near-you-modal-grant-permission-info':
      'Usluge lokacije možete omogućiti u postavkama telefona ili preglednika, omogućavajući aplikaciji upotrebu vašeg trenutnog mjesta.',
    'stop-near-you-modal-header': 'Niste omogućili usluge lokacije',
    'stop-near-you-modal-info':
      'Korištenje obližnjih stajališta zahtjeva pristup lokacijskim uslugama.',
    'stop-near-you-title': 'Pretražite stajališta i rute',
    'stop-near-you-update-alert': 'Najbliža stajališta ažurirana',
    'stop-number': 'Broj stajališta',
    'stop-page.description': 'Stajalište {name} - {code}',
    'stop-page.right-now.loaded': 'stranica stajališta učitana',
    ...
    'street-mode-bike-aria':
      'Prikaži biciklističku rutu. Trajanje {duration}, udaljenost {length})',
    'street-mode-bikeandvehicle-aria':
      'Prikaži kombinaciju biciklizma i javnog prijevoza. Trajanje {duration}, udaljenost {length}',
    ...
    'street-mode-walk-aria':
      'Prikaži rutu pješačenja. Trajanje {duration}, udaljenost {length}',
    subway: 'Metro',
    'subway-with-route-number': 'Metro {routeNumber} {headSign}',
    'summary-page.description': '{from} - {to}',
    ...
    tickets: 'Karte',
    time: 'Vrijeme',
    'time-navigation-buttons': 'Gumbi za odabir vremena',
    'time-selector-form': 'Uredi vrijeme',
    ...
    'use-national-service-postfix': '.',
    'use-national-service-prefix':
      'Preporučujemo da isprobate nacionalni planer putovanja, ',
    'use-own-position': 'Koristi trenutnu lokaciju',
    userinfo: 'Moje informacije',
    ...
    'via-point': 'Točka',
    'via-point-index': 'Koristeći točku {index}',
    'viapoint-slack-amount': 'Vrijeme zaustavljanja',
    'view-route': 'Pregledaj Routu',
    wait: 'Čekanje',
    'wait-amount-of-time': 'Čekanje {duration}',
    walk: 'hodanje',
    'walk-bike-itinerary-1': 'Vaša pretraga sadržava samo rute za pješačenje',
    'walk-bike-itinerary-2': 'Vaša pretraga sadržava samo rute za bicikliranje',
    'walk-bike-itinerary-3':
      'Vaša pretraga sadržava samo rute za bicikliranje i pještačenje',
    ...
    'weather-data-source': 'Izvor: Finski Meteorološki institut',
    'weather-detail-title': 'Vremenska prognoza za polaznu točku u',
    'weather-icon-1': 'Vedro',
    'weather-icon-2': 'Djelomična naoblaka',
    'weather-icon-21': 'Lagani pljuskovi',
    'weather-icon-22': 'Pljuskovi',
    'weather-icon-23': 'Jako pljuskovi',
    'weather-icon-3': 'Oblačno',
    'weather-icon-31': 'Blaga kiša',
    'weather-icon-32': 'Kiša',
    'weather-icon-33': 'Jaka kiša',
    'weather-icon-41': 'Slabi pljuskovi snijega',
    'weather-icon-42': 'Pljuskovi snijega',
    'weather-icon-43': 'Jaki snježni pljuskovi',
    'weather-icon-51': 'Slabe snježne padavine',
    'weather-icon-52': 'Snježne padavine',
    'weather-icon-53': 'Jake snježne padavine',
    'weather-icon-61': 'Pljuskovi s grmljavinom',
    'weather-icon-62': 'Jaki pljuskovi s grmljavinom',
    'weather-icon-63': 'Grmljavina',
    'weather-icon-64': 'Jaka grmljavina',
    'weather-icon-71': 'Slabi pljuskovi sa susnježicom',
    'weather-icon-72': 'Pljuskovi sa susnježicom',
    'weather-icon-73': 'Jaki pljuskovi sa susnježicom',
    'weather-icon-81': 'Slaba susnježica',
    'weather-icon-82': 'Susnježica',
    'weather-icon-83': 'Jaka susnježica',
    'weather-icon-91': 'Maglovito',
    'weather-icon-92': 'Magla',
    where: 'Gdje putujete?',
    yesterday: 'Jučer',
    zone: 'Zona',
    zones: 'Zone',
