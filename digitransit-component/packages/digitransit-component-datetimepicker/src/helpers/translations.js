const translations = {
  ...
  hr: {
    today: 'Danas',
    tomorrow: 'Sutra',
    'accessible-close': 'Zatvori odabir vremena',
    'accessible-closed': 'Odabir vremena zatvoren',
    'accessible-open': 'Otvori odabir vremena',
    'accessible-opened': 'Odabir vremena otvoren',
    'accessible-title': 'Datum i vrijeme',
    arrival: 'Dolazak',
    date: 'Datum',
    departure: 'Odlazak',
    'departure-now': 'Odlaze sada',
    time: 'Vrijeme',
  },
  sv: {
    today: 'I dag',
