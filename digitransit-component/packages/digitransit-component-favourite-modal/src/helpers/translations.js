const translations = {
  ...
  hr: {
    cancel: 'Odustani',
    'choose-icon': 'Odaberite ikonu za mjesto',
    'close-favourite-modal': 'Zatvori prozor',
    'edit-place': 'Uredi mjesto',
    'favourite-modal-on-add-new': 'Dodaj novog favorita',
    'favourite-modal-on-edit': 'Uređivanje favorita: {{favourite.name}}',
    'input-placeholder': 'Dajte imenu mjesto (optional)',
    save: 'Spremi',
    'save-place': 'Spremi mjesto',
    'cannot-save-place': 'Nije moguće spremiti mjesto bez adrese ili ikone',
    place: 'mjesto',
    home: 'dom',
    work: 'posao',
    sport: 'sport',
