const translations = {
  ...
  hr: {
    cancel: 'Odustani',
    delete: 'Obriši',
    'delete-place-header': 'Želite li obrisati mjesto?',
    'delete-place-name': 'Obriši mjesto: {{favourite.name}}',
    'edit-places': 'Uredi mjesta',
    'edit-place-name': 'Uredi mjesto: {{favourite.name}}',
    'edit-modal-on-open': 'Uređivač favorita.',
    'choose-icon': 'Odaberite ikonu za mjesto',
    'close-modal': 'Zatvori prozor',
    'input-placeholder': 'Dodjelite ime mjestu (opcionalno)',
    save: 'Spremi',
