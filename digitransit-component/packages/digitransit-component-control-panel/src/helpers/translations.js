const translations = {
  ...
  hr: {
    'pick-mode': 'Odaberite način prijevoza',
    'pick-mode-airplane': 'Let',
    'pick-mode-bus': 'Bus',
    'pick-mode-citybike': 'Gradski bicikl',
    'pick-mode-ferry': 'Trajekt',
    'pick-mode-rail': 'Željeznica',
    'pick-mode-subway': 'Metro',
    'pick-mode-tram': 'Tramvaj',
    'placeholder-destination': 'Unesite odredište',
    'placeholder-origin': 'Unesite polazište',
    'placeholder-route-stop-station': 'Unesite rutu, stajalište ili stanicu',
    'title-route-stop-station': 'Obližnja stajališta i rute',
    'title-origin-to-destination': 'Gdje?',
